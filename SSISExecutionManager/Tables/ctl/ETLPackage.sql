...
EXECUTE sp_addextendedproperty @name = N'MS_Description',@value = N'If this package is executed via a parent/main package but an admin would like to execute it directly, this flag should be set to True.',@level0type = N'SCHEMA',@level0name = N'ctl',@level1type = N'TABLE',@level1name = N'ETLPackage',@level2type = N'COLUMN',@level2name = N'BypassEntryPointInd';

GO

EXECUTE sp_addextendedproperty @name = N'MS_Description',@value = N'Lets the control process know that the package should be picked up for execution. This will be set by the initialize process as well as manually when resetting after a failure.',@level0type = N'SCHEMA',@level0name = N'ctl',@level1type = N'TABLE',@level1name = N'ETLPackage',@level2type = N'COLUMN',@level2name = N'ReadyForExecutionInd';

GO

EXECUTE sp_addextendedproperty @name = N'MS_Description',@value = N'Indicates whether the package should be included for execution and dependency checks regardless of whether it is an entry point package.',@level0type = N'SCHEMA',@level0name = N'ctl',@level1type = N'TABLE',@level1name = N'ETLPackage',@level2type = N'COLUMN',@level2name = N'EnabledInd';

GO

EXECUTE sp_addextendedproperty @name = N'MS_Description',@value = N'If this package is executed via a parent/main package, this is the Id of that package.',@level0type = N'SCHEMA',@level0name = N'ctl',@level1type = N'TABLE',@level1name = N'ETLPackage',@level2type = N'COLUMN',@level2name = 'EntryPointETLPackageId';
