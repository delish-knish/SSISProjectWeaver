CREATE TABLE [ctl].[ETLPackage_SQLCommandTrigger]
  (
     ...
     ,[LastUpdatedDate]					DATETIME2 (7) CONSTRAINT [DF_ETLPackage_SQLCommandTrigger_LastUpdatedDate] DEFAULT (GETDATE()) NOT NULL
     ,[LastUpdatedUser]					VARCHAR (50) CONSTRAINT [DF_ETLPackage_SQLCommandTrigger_LastUpdatedUser] DEFAULT (SUSER_SNAME()) NOT NULL
