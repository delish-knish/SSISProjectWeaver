CREATE TABLE [cfg].[ETLPackageGroup_ETLPackageGroupDependency]
  (
     ...
     CONSTRAINT [FK_ETLPackageGroup_ETLPackageGroupDependency_ETLPackageGroup] FOREIGN KEY (ETLPackageGroupId) REFERENCES [cfg].ETLPackageGroup(ETLPackageGroupId),
     CONSTRAINT [FK_ETLPackageGroup_ETLPackageGroupDependency_ETLPackage_DependentOn] FOREIGN KEY ([DependedOnETLPackageGroupId]) REFERENCES [cfg].ETLPackageGroup(ETLPackageGroupId),
