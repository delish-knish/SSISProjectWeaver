CREATE TABLE [cfg].[ETLPackageGroup_ETLPackage]
  (
     ...
     ,[IgnoreForBatchCompleteDefaultInd] BIT CONSTRAINT [DF_ETLPackageGroup_ETLPackage_IgnoreForBatchCompleteDefaultInd] DEFAULT (0) NOT NULL
     ...
     ,[BypassEntryPointDefaultInd]       BIT CONSTRAINT [DF_ETLPackageGroup_ETLPackage_ByPassEntryPointDefaultInd] DEFAULT ((0)) NOT NULL
     ,[IgnoreDependenciesDefaultInd]     BIT CONSTRAINT [DF_ETLPackageGroup_ETLPackage_IgnoreDependenciesDefaultInd] DEFAULT ((0)) NOT NULL
	 ,[IgnoreSQLCommandConditionsDefaultInd] BIT CONSTRAINT [DF_ETLPackageGroup_ETLPackage_IgnoreSQLCommandConditionsDefaultInd] DEFAULT ((0)) NOT NULL
     ,[MaximumRetryAttemptsDefault]      INT CONSTRAINT [DF_ETLPackageGroup_ETLPackage_MaximumRetryAttemptsDefault] DEFAULT ((0)) NOT NULL
     ...
     ,[ExecuteNthDayOfMonth]				 TINYINT CONSTRAINT [DF_ETLPackageGroup_ETLPackage_ExecuteNthDayOfMonth] DEFAULT ((0)) NOT NULL --0 = all days
